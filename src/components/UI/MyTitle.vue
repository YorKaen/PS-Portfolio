<template lang="pug">
.title
    h3.txt.txt-white {{ txtTitle }}
    .views(title="Подсчет, сколько раз вы посетили эту страницу")
        .views-counter.txt.txt-white {{ visitsCount }}
        <svg class="views-icon" width="22" height="16" viewBox="0 0 22 16" fill="white" xmlns="http://www.w3.org/2000/svg">
