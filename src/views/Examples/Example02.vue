  ...
  data: () => ({
    setNavFixed: false,
      ...
      dataRunningNumbers: [
        ...
        activeTab:{},
        activeDataPriceTab: [],
        dataPriceContentHair: [{name: 'Стрижка женская', price: 'от 400 руб.'},{name: 'Стрижка мужская', price: 'от 400 руб.'},{name: 'Окрашивание', price: 'от 400 руб.'},{name: 'Стрижка детская', price: 'от 400 руб.'},{name: 'Стрижка горячими ножницами', price: 'от 2000 руб.'},{name: 'Лифтинг для волос', price: ' от 2000 руб.'},{name: 'Оформление бороды', price: ' от 250 руб.'},{name: 'Оформление усов', price: ' от 50 руб.'},{name: 'Ламинирование волос', price: 'от 500 руб.'},{name: 'Наращивание волос (горячее, холодное) ленточное', price: ' от 5000 руб.'},],
      dataPriceContentCosmet: [{name: 'Стрижка женская2', price: 'от 400 руб.'},{name: 'Стрижка мужская', price: 'от 400 руб.'},{name: 'Окрашивание', price: 'от 400 руб.'},{name: 'Стрижка детская', price: 'от 400 руб.'},{name: 'Стрижка горячими ножницами', price: 'от 2000 руб.'},{name: 'Лифтинг для волос', price: ' от 2000 руб.'},{name: 'Оформление бороды', price: ' от 250 руб.'},{name: 'Оформление усов', price: ' от 50 руб.'},{name: 'Ламинирование волос', price: 'от 500 руб.'},{name: 'Наращивание волос (горячее, холодное) ленточное', price: ' от 5000 руб.'},],
      dataPriceContentManic: [{name: 'Стрижка женская3', price: 'от 400 руб.'},{name: 'Стрижка мужская', price: 'от 400 руб.'},{name: 'Окрашивание', price: 'от 400 руб.'},{name: 'Стрижка детская', price: 'от 400 руб.'},{name: 'Стрижка горячими ножницами', price: 'от 2000 руб.'},{name: 'Лифтинг для волос', price: ' от 2000 руб.'},{name: 'Оформление бороды', price: ' от 250 руб.'},{name: 'Оформление усов', price: ' от 50 руб.'},{name: 'Ламинирование волос', price: 'от 500 руб.'},{name: 'Наращивание волос (горячее, холодное) ленточное', price: ' от 5000 руб.'},],
      dataPriceContentPanic: [{name: 'Стрижка женская4', price: 'от 400 руб.'},{name: 'Стрижка мужская', price: 'от 400 руб.'},{name: 'Окрашивание', price: 'от 400 руб.'},{name: 'Стрижка детская', price: 'от 400 руб.'},{name: 'Стрижка горячими ножницами', price: 'от 2000 руб.'},{name: 'Лифтинг для волос', price: ' от 2000 руб.'},{name: 'Оформление бороды', price: ' от 250 руб.'},{name: 'Оформление усов', price: ' от 50 руб.'},{name: 'Ламинирование волос', price: 'от 500 руб.'},{name: 'Наращивание волос (горячее, холодное) ленточное', price: ' от 5000 руб.'},],
  }),
  created() {},
  mounted() {
  ...
  .nav-wrapper {
    ...
    justify-content: center;
      @include breakpoint(lg){
          .nav-contacts {margin-right: 30%;}
          .title-shape {margin-left: 30%;}
      }
    .nav-contacts {
      margin-right: 5%;
      margin-left: 2em;
...
.block-numbers{
    .wrapper{
        ...
        @include breakpoint(md){grid-template-columns: repeat(4, 1fr);}
        .item:nth-child(1){
            background-color: $pink-1;
        }
        .item:nth-child(2){
